  ...
  head: () => ({
    meta: [
      ...
      { title: "Central de Inteligência Comercial | Microsistec" },
      {
        name: "description",
        content:
          "Plataforma interna da Microsistec com processos comerciais, produtos, precificação e argumentação.",
      },
      { name: "author", content: "Microsistec" },
      { property: "og:title", content: "Central de Inteligência Comercial | Microsistec" },
      {
        property: "og:description",
        content: "Base de conhecimento comercial interna da Microsistec.",
      },
